...
pesoPeixes = float(input("Digite a quantidade de kilos de peixes: "))
if pesoPeixes < 50.0:
    print("Não há excedente de peso.")
else:
    excedentePeso = pesoPeixes - 50
    multaPeso = excedentePeso * 4
    print(f"Houve excedente de {excedentePeso} Kg(s) e o valor da multa é de R$ {multaPeso}")